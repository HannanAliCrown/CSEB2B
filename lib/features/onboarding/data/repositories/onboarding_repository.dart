...
class OnboardingRepository {
  ...
  Future<void> applyLanguage(String languageCode, {required bool remember}) {
    return _preferences.setRememberedLanguage(remember ? languageCode : null);
  }
  ...
  Future<void> skipLocation() =>
      _preferences.setLocationOutcome(PermissionOutcome.denied.name);

  Future<void> openSystemSettings() => _permissions.openSettings();

  Future<void> completeFirstLaunch() =>
      _preferences.setFirstLaunchComplete(complete: true);
