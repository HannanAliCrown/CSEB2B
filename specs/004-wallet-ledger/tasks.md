...
- [x] T002 [P] Retain wallet/cash schema in `db/migrations/002_dashboard.sql` and `db/migrations/006_cash_and_scan.sql`.

## Phase 2: User Story 1 - Send Cash
- [x] T003 [US1] Validate minimum amount, self-recipient, recipient, and balance in `prototype_server/lib/data/postgres_wallet_data_store.dart`.
...
- [x] T005 [US1] Cover recipient selection and review/send states in `lib/features/wallet/ui/wallet_view_model.dart`.
