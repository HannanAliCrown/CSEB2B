...
- [x] T002 [P] Retain social schema in `db/migrations/003_space_and_chat.sql`.

## Phase 2: User Story 1 - Space
- [x] T003 [US1] Filter Space feed by audience and active content in `prototype_server/lib/data/postgres_social_data_store.dart`.
