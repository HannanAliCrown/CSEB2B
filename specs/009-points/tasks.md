...
- [x] T004 [US1] Render no-scheme, quarterly, annual, and extra-target states in `lib/features/points/ui/`.
...
- [ ] T011 Document automatic 1% accrual and SAP integration as out of scope in `specs/009-points/spec.md`.
