...
- [x] T005 [US1] Render unavailable, no-spins, success, and history states in `lib/features/inaam_baazar/ui/views/inaam_tab.dart`.
...
- [x] T009 [US2] Render item scheme progress and claim outcomes in `lib/features/inaam_baazar/ui/views/inaam_tab.dart`.

## Phase 4: User Story 3 - Reward Program
- [x] T010 [US3] Display configured current program and prior award in `lib/features/inaam_baazar/ui/views/inaam_tab.dart`.
...
## Phase 5: Polish
- [ ] T012 Run all Inaam scenarios from `specs/010-inaam-rewards/quickstart.md` and verify role restrictions in `lib/app/shell/app_shell.dart`.
